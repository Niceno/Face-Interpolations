    ...
    switch(algor)
      ...
      case 'Linear_From_Matrix'
        [u_if, u_af] = flux_02_linear_from_matrix(                   ...
                       dv, urf_u, a_u*urf_u, t_u, f_c,               ...
                       u_c, u_c_o, u_c_star, p_x);
      case 'Rhie-Chow_From_Velocities'
        [u_if, u_af] = flux_03_rc_from_velocities(                   ...
                       x_c, dv, a_u*urf_u,                           ...
                       u_c, p_c, p_x);
      case 'Rhie-Chow_From_Matrix'
        [u_if, u_af] = flux_04_rc_from_matrix(                       ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_c,          ...
                       u_c, u_c_o, u_c_star, p_c, p_x);
      case 'Rhie-Chow_Majumdar_From_Velocities'
        [u_if, u_af] = flux_05_rc_majumdar_from_velocities(          ...
                       x_c, dv, urf_u, a_u*urf_u,                    ...
      ...
      case 'Rhie-Chow_Majumdar_Choi_Gu_From_Velocities'
        [u_if, u_af] = flux_09_rc_majumdar_choi_gu_from_velocities(  ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_c, f_if,    ...
                       u_c, u_c_o, u_c_star,                         ...
                       u_if_o, u_if_star,                            ...
                       p_c, p_x);
      case 'Rhie-Chow_Majumdar_Choi_Gu_From_Matrix'
        [u_if, u_af] = flux_10_rc_majumdar_choi_gu_from_matrix(      ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_if,         ...
                       u_c, u_if_o, u_if_star, p_c, p_x);
      case 'Rhie-Chow_Choi_From_Velocities'
        [u_if, u_af] = flux_11_rc_choi_from_velocities(              ...
                       x_c, dv, urf_u, a_u*urf_u, t_u,               ...
                       u_c, u_c_o, u_c_star,                         ...
                       u_if_o, u_if_star,                            ...
                       p_c, p_x);
      case 'Rhie-Chow_Choi_From_Matrix'
        [u_if, u_af] = flux_12_rc_choi_from_matrix(                  ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_c,          ...
                       u_c, u_if_o, u_if_star, p_c, p_x);
      case 'Rhie-Chow_Choi_Gu_From_Velocities'
        [u_if, u_af] = flux_13_rc_choi_gu_from_velocities(           ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_c, f_if,    ...
                       u_c, u_c_o, u_c_star,                         ...
                       u_if_o, u_if_star,                            ...
                       p_c, p_x);
      case 'Rhie-Chow_Choi_Gu_From_Matrix'
        [u_if, u_af] = flux_14_rc_choi_gu_from_matrix(               ...
                       x_c, dv, urf_u, a_u*urf_u, t_u, f_if,         ...
                       u_c, u_if_o, u_if_star, p_c, p_x);
      otherwise
